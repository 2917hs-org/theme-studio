...
export const LANGUAGES: LanguageDef[] = [
  ...
  { id: 'c', label: 'C', scopeName: 'source.c', grammarFile: assetUrl('grammars/c.tmLanguage.json'), generate: samples.c, accent: '#a8b9cc' },
  { id: 'powershell', label: 'PowerShell', scopeName: 'source.powershell', grammarFile: assetUrl('grammars/powershell.tmLanguage.json'), generate: samples.powershell, accent: '#4391c1' },
  { id: 'kotlin', label: 'Kotlin', scopeName: 'source.kotlin', grammarFile: assetUrl('grammars/kotlin.tmLanguage.json'), generate: samples.kotlin, accent: '#7f52ff' },
  { id: 'dart', label: 'Dart', scopeName: 'source.dart', grammarFile: assetUrl('grammars/dart.tmLanguage.json'), generate: samples.dart, accent: '#0175c2' },
